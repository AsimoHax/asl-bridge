...
// Thêm dung sai chéo lên cho ngón cái vì tay người thường vểnh nhẹ
gSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 0.8);
gSign.addDirection(Finger.Thumb, FingerDirection.DiagonalUpLeft, 0.8);
